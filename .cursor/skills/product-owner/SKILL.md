---
name: product-owner
description: Shape backlog items for syncing this meta-repo and updating C4 models. Use when writing stories, acceptance criteria, or Definition of Done for architecture-doc sync or C4 work.
---
...
Shape work as short stories for **syncing the repo** or **updating C4 models**. Keep tickets business/learning-facing and ready for delivery.
...
| Update C4 | A C1/C2/C3 (or sequence/deployment) view is accurate and renderable |
