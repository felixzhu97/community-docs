...
> **Scope:** Angular, React, React Native, and Spring (`angular`, `react`, `react-native`, `spring-boot`, `spring-ai`, `spring-security`).  
...
4. Read [Spring Boot C4](spring-boot/docs/c4-model/) for bootstrap, Auto-Configuration, and Actuator
5. Read [Spring AI C4](spring-ai/docs/c4-model/) for ChatClient, RAG / ETL, and MCP layering
6. Study [Spring Security C4](spring-security/docs/c4-model/), focusing on trust boundaries and deployment / sequence views
7. Compare how framework APIs, adapters, and tooling are separated across these projects
